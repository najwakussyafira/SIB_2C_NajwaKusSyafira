...
?>" class="btn btn-edit" title="Edit karyawan">
                        Edit
                    </a>
                    <a href="index.php?action=delete&id=<?php echo $row['id'];
?>" class="btn btn-delete" title="Hapus karyawan" onclick="return confirm('Apakah Anda yakin ingin
menghapus karyawan <?php echo htmlspecialchars($row['first_name'] . ' ' .
$row['last_name']); ?>?')">
                        Hapus
                    </a>
                </div>
